...
//
//Views are a function of a program's state
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $showingScore){
            Alert(title: Text(scoreTitle), message: Text("Your score is \(self.numberCorrect)"), dismissButton: .default(Text("Continue")){
                self.askQuestion()
                })
        }
    }
